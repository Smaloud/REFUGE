...
class UNet(nn.Module):
    def __init__(self, in_channels: int = 3, num_classes: int = 3, base_channels: int = 32) -> None:
        ...
        self.up1 = Up(base_channels * 24, base_channels * 8)
        self.up2 = Up(base_channels * 12, base_channels * 4)
        self.up3 = Up(base_channels * 6, base_channels * 2)
        self.up4 = Up(base_channels * 3, base_channels)
